...
public sealed class CustomerReferralTests
{
    ...
    public void Create_NormalizesMobileAndStartsWaiting()
    {
        ...
        var referral = CustomerReferral.Create(7, "98765 43210", "martabc123", createdOn);
    ...
    {
        var referral = CustomerReferral.Create(7, "9876543210", "MARTABC123", DateTime.UtcNow);
    ...
    public void Validator_RejectsInvalidMobileNumbers(string mobileNumber)
    {
        ...
        var result = validator.TestValidate(new CreateCustomerReferralCommand(7, mobileNumber));
